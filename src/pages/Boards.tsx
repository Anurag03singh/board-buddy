  ...
  return (
    <div className="min-h-screen bg-zinc-100 noise-bg relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        {/* Floating animated squares with borders - pointer-events-none */}
        ...
        {/* Accent colored squares - pointer-events-none */}
        ...
        <div className="absolute top-1/4 right-1/2 w-5 h-5 bg-red-500 rotate-45 animate-glow pointer-events-none" style={{ animationDelay: '2.5s' }} />
        ...
        <div className="absolute bottom-20 left-1/2 w-4 h-4 rotate-45 animate-blink-red cursor-pointer transition-all duration-300 hover:scale-150 hover:opacity-100 hover:shadow-[0_0_30px_rgba(239,68,68,0.8)]" style={{ animationDelay: '1.4s' }} />
        
        {/* Additional scattered elements - pointer-events-none */}
        <div className="absolute top-16 right-20 w-10 h-10 border border-zinc-300 rotate-45 animate-float opacity-20 pointer-events-none" style={{ animationDelay: '0.8s' }} />
        <div className="absolute bottom-16 left-20 w-12 h-12 border border-zinc-300 rotate-45 animate-pulse-subtle opacity-20 pointer-events-none" style={{ animationDelay: '2.2s' }} />
      </div>
